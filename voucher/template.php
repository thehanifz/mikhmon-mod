...
elseif($getsprice == "2000"){ $color = "#D3D3D3";}
elseif($getsprice == "3000"){ $color = "#666";}
elseif($getsprice == "5000"){ $color = "#98FB98";}
elseif($getsprice == "10000"){ $color = "#4169E1";}
elseif($getsprice == "15000"){ $color = "#228B22";}
elseif($getsprice == "20000"){ $color = "#FF0000";}
...
<?php if($v_opsi=='up'){ ?>
<?php }else{ ?>
<div style="padding:0px;border-bottom:1px solid<?php echo $color ?>;text-align:center;font-weight:bold;font-size:10px;">VOUCHER STANDART</div>
